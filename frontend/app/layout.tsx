  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="bg-gray-950 text-gray-100 font-sans">
        <div className="flex">
          {/* Sidebar */}
          <aside className="fixed left-0 top-0 h-screen w-64 backdrop-blur-xl bg-white/5 border-r border-white/10 p-6 z-50">
            {/* Logo */}
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 p-3 rounded-xl text-center text-xs text-gray-400">
