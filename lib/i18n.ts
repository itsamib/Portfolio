...
export const translations: Record<Language, Record<string, string>> = {
  ...
  fa: {
    ...
    'interest.title': 'مدیریت سود و سررسید وجه نقد',
    'interest.subtitle': 'تعیین سود سالانه یا ماهانه و تاریخ سررسید برای واریز خودکار سود به پورتفوی',
    'interest.add': 'افزایش / ثبت سود وجه نقد',
    'interest.rate': 'درصد سود',
    'interest.period': 'دوره سود',
    'interest.yearly': 'سالانه',
    'interest.monthly': 'ماهانه',
    'interest.maturityDate': 'تاریخ سررسید',
    'interest.principal': 'مبلغ اصل وجه نقد',
    'interest.calcAmount': 'مبلغ سود محاسبه‌شده',
    'interest.popupTitle': '🔔 سررسید سود وجه نقد فرا رسیده است!',
    'interest.popupDesc': 'موعد سررسید دریافت سود برای وجه نقد زیر فرا رسیده است. آیا مایلید این مبلغ سود به پورتفوی شما واریز شود؟',
    'interest.depositAction': 'واریز و افزودن به پورتفوی',
    'interest.skipAction': 'انصراف / عدم واریز',
